...
const ComparisonTable = ({ targets, result }) => {
    ...
    const metrics = [
        { label: 'Weight', target: targets.mw, actual: actual.mw, unit: 'Da' },
        { label: 'LogP', target: targets.logp, actual: actual.logp, unit: '' },
        { label: 'TPSA', target: targets.tpsa, actual: actual.tpsa, unit: 'Å²' },
        { label: 'QED', target: targets.qed, actual: actual.qed, unit: '' },
    ];
