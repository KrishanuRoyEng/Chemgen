    ...
    const handleReferenceSearch = async () => {
        ...
        try {
            ...
            for (const name of names) {
                ...
                const pcRes = await fetch(`https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/${name}/property/SMILES/JSON`);
            ...
            if (allChemicalData.length === 0) throw new Error("No valid compounds found");
        ...
        <div className="min-h-screen bg-cyber-black text-white p-4 md:p-8 font-sans selection:bg-neon-blue selection:text-white">
            ...
            <header className="flex justify-between items-center mb-8 border-b border-white/10 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tighter">CHEMGEN <span className="text-neon-blue font-black italic">INTERPOLATOR</span></h1>
                        <p className="text-[10px] text-gray-500 font-mono tracking-widest uppercase">Lead-Optimization Engine v2.5</p>
                    </div>
                </div>
            </header>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4">
                    <ControlDeck
                        ...
                        mw={mw} setMw={setMw}
                        logp={logp} setLogp={setLogp}
                        tpsa={tpsa} setTpsa={setTpsa}
                        hbd={hbd} setHbd={setHbd}
                        hba={hba} setHba={setHba}
                        rings={rings} setRings={setRings}
                        qed={qed} setQed={setQed}
                        toxicity={toxicity} setToxicity={setToxicity}
                        rot={rot} setRot={setRot}
